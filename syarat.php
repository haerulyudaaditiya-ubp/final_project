...
<div class="container py-5">
  <div class="row justify-content-center">
    <div class="col-lg-8" data-aos="fade-down" data-aos-duration="1200">
      <!-- Judul -->
      <h1 class="fw-bold text-center mb-4" style="color: #000;">Syarat & Ketentuan</h1>
    </div>
  </div>
  <div class="row justify-content-center">
    <div class="col-lg-8" data-aos="fade-up" data-aos-duration="1500">
      ...
      <ol style="font-size: 1rem; line-height: 1.6; color: #333;">
        ...
        <li><strong>Dokumen yang Diperlukan:</strong> Fotokopi KTP atau Paspor serta dokumen lain yang relevan wajib diserahkan sebagai identitas resmi.</li>
      ...
      <p style="font-size: 1rem; line-height: 1.6; color: #333;">
        Dengan menyetujui syarat dan ketentuan ini, Anda menyatakan bahwa telah memahami dan akan mematuhi seluruh peraturan yang berlaku.
      </p>
    </div>
  </div>
  ...
  <div class="row justify-content-center mt-4">
    <div class="col-lg-8 text-center" data-aos="zoom-in" data-aos-duration="1200">
      <a href="contact.php" class="btn btn-warning fw-bold px-5 py-2" style="font-size: 1rem; box-shadow: 0px 4px 6px rgba(0,0,0,0.2);">
        Hubungi Kami
      </a>
    </div>
  </div>
